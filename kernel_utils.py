...
def parse_args_and_config():
    ...
    parser.add_argument('--test_folder', type = str, default= 'test_data', help = 'directory for occlusion area conversion')
    parser.add_argument('--bin_path', type = str, default= '0000000000.bin', help = 'path for point cloud file')
    parser.add_argument('--img_path', type = str, default= '0000000000.png', help = 'path for image file')
